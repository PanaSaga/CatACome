...
import {
  ...
  PICK_CD, PICK_DMG, PICK_POWER_MAX, PICK_RANGE_MAX, HP_LEVELS, DRILL_CHARGE_MAX, clinicCost, clinicCap, bankFeeRate, currencyText, M_PER_TILE,
...
const UPGRADES = [
  ...
  { key: 'pickRange', name: '곡괭이 범위', max: PICK_RANGE_MAX, detail: (lv) => `Lv${lv} — 흙 ${lv}×${lv}` },
