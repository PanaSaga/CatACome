...
export const DRILL = {
  length: [6, 7, 9, 10, 12, 13, 15, 16, 19], // 돌진 거리(타일) — 레벨만큼 늘어난다
  duration: [0.35, 0.39, 0.44, 0.48, 0.53, 0.57, 0.62, 0.66, 0.76], // 돌진 지속시간(초, 무적 겸용)
...
// ── 진행 (§5) ────────────────────────────────────────────────────
// 레벨 캡 5→8(§7)에 맞춰 7칸(Lv1→2 ... Lv7→8)으로 늘었다. 최고 레벨의 세기가
// 예전과 같아졌으니 만렙까지 드는 총비용도 예전과 비슷한 수준으로 눌러 담았다
// (예전엔 4단만 사면 만렙이었으니 한 단당 비용은 이전보다 더 낮아진다).
export const PRICES = {
  pickSpeed: [8, 20, 50, 125, 300, 750, 1800],
  pickRange: [8, 20, 50, 125, 300, 750, 1800],
  sonar: [8, 20, 45, 100, 220, 480, 1000],
  grapple: [50, 200, 800],
  bomb: [5, 12, 28, 65, 150, 350, 800],
  drill: [5, 12, 28, 65, 150, 350, 800],
  laser: [5, 12, 28, 65, 150, 350, 800],
  flag: [5, 12, 28, 65, 150, 350, 800],
  maxHp: [500, 2000],
};
