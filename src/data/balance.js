...
// 만렙을 찍는 값이니 3~5백금(3000~5000구리)이 들도록 곡선의 끝을 다시 맞췄었다 —
// 곡괭이 속도가 5백금, 소나가 4백금, 폭탄·드릴·레이저·플래그가 3백금(§ 아래 3~5배
// 상향 전 기준값).
// 범위·공격력은 레벨이 3단뿐이라(§3-1) 단계별로 나누지 않고, 예전(8단) 가격표의
// 최댓값을 그대로 매 단계 값으로 썼다 — "업그레이드 비용은 현재 레벨의 최대치".
// 그 위에 전부 크게 상향 — 1레벨은 그 기준값의 3배, 만렙은 5배가 되도록 배율을
// 3→5로 선형 보간해 곱하고 보기 좋은 단위로 정리했다.
export const PRICES = {
  pickSpeed: [25, 85, 260, 800, 2500, 7950, 25000],
  pickRange: [15000, 25000],
  sonar: [25, 75, 220, 680, 2100, 6300, 20000],
  grapple: [150, 800, 4000],
  bomb: [15, 45, 150, 460, 1450, 4450, 15000],
  drill: [15, 45, 150, 460, 1450, 4450, 15000],
  laser: [15, 45, 150, 460, 1450, 4450, 15000],
  flag: [15, 45, 150, 460, 1450, 4450, 15000],
  maxHp: [1500, 10000],
  pickPower: [450, 750],
};
